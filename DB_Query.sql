...
CREATE TABLE [dbo].[ship] (
    ...
    [status]              INT NOT NULL DEFAULT 0, /* 0 -> importing, 1 -> exporting */
...
CREATE TABLE [dbo].[custom_duty] (
    ...
    [imp_exp]    INT NOT NULL DEFAULT 0,            
...
INSERT INTO [ship] (hin, trader_id, nick_name, allocated_birth, allocated_terminal, status, created_at, updated_at) VALUES ('22223346', 2, 'Fortune''s End', 2, 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO [item] (name, price, currency, manufacturer, trader_id, category, created_at, updated_at) VALUES ('GTX 1660S', 30000, 'PKR', 'Nvidia', 2, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO [item] (name, price, currency, manufacturer, trader_id, category, created_at, updated_at) VALUES ('Ryzen 5 3600X', 45000, 'PKR', 'AMD', 2, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO [item] (name, price, currency, manufacturer, trader_id, category, created_at, updated_at) VALUES ('RTX 3060', 50000, 'PKR', 'Nvidia', 3, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
